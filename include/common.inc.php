...
define('UC_DBUSER', 'gulianlvyou');
define('UC_DBPW', '0411lvyou_)$!!LVYOU');
define('UC_DBNAME', 'gulianbbs');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`gulianbbs`.glly_ucenter_');
define('UC_DBCONNECT', '0');
define('UC_KEY', '27U5s8L6c2H5Tdx5KfEfafB8Ccy1y8n99883V5wcK1z6O2OdjfT5S2g8J5a2y6b4');
define('UC_API', 'http://faq.gulianlvyou.com/uc_server');
