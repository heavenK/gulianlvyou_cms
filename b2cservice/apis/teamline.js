...
function initFloatPerson(group) {
	...
	text += '<ul>'
		...
		+ '<li style="width:80px;"> <span>成人：</span> <span class="add_count"><input type="text" value="1"  /><span class="less"></span> <span class="add"></span> </span> <span>&nbsp;人</span> </li>'
		+ '<li class="pwidth" style="width:120px;">儿童不占床不占票价：</li><li class="pwidth2"><b class="piaohong">￥' + group.child_price + '</b></li>'
		+ '<li style="width:80px;"> <span>儿童：</span> <span class="add_count"><input type="text" value="0"  /><span class="less"></span> <span class="add"></span> </span> <span>&nbsp;人</span> </li>'
		+'</ul>';
