...
//    }
    ...
    ShowMsg('成功更新你的基本资料！',B2CSERVICE_URL.'apis/action_edit_baseinfo.php',0,5000);
	
//    ShowMsg('成功更新你的基本资料！','edit_baseinfo.php',0,5000);
    exit();
}
$face = FileGetContents(B2CSERVICE_INDEX."DISCUZInfo/interface_getUserFace/mid/".$cfg_ml->fields['mid']);

include("../B2CService/Tpl/My/edit_baseinfo.htm");
